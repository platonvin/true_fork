...
constexpr NonEnumType to_underlying(NonEnumType e) noexcept
    requires IsNotEnum<NonEnumType>
{
    return (e);
}

export template <auto EnumSize, typename Type>
class FixedMap {
